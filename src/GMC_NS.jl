module GMC_NS
    ...
    GMC_DEFAULTS=Vector{Any}([500,.25,500,.95,.002, .001, .01, 10.])
    export GMC_DEFAULTS
    ...
    export ensemble_history, clean_ensemble_dir, complete_evidence, reset_ensemble!, move_ensemble!, copy_ensemble!, rewind_ensemble, show_models, get_model
